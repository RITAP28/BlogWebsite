...
const userSchema = new mongoose.Schema({
    username: {
        ...
        maxLength: [15, 'Name should be at most 15 characters'],
        unique: true,
    },
    email: {
        type: String,
    ...
    onboardingData1: {
        ...
        required: [
            true,
            'Please provide the required answer',
        ],
    },
    onboardingData2: {
        type: String,
        minLength: [4, 'More than 4 characters required'],
...
const postSchema = new mongoose.Schema({
    ...
    content: {
        type: String,
        required: true,
        minLength: [100, 'Content should contain at least 100 characters']
    },
    author: {
